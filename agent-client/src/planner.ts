...
export type PlannerAction = "snapshot" | "history" | "deep-dive" | "price" | "risk-scan" | "whale-watch" | "recommend";
...
const ACTIONS: PlannerAction[] = ["snapshot", "history", "deep-dive", "price", "risk-scan", "whale-watch", "recommend"];
...
function systemPrompt(
  ...
  return [
    ...
    catalog,
    'Reply with STRICT JSON only: {"action": "snapshot" | "history" | "deep-dive" | "price" | "risk-scan" | "whale-watch" | "recommend", "reason": "string", "symbol": "optional USDC|DAI|USDT for history/deep-dive/price/whale-watch"}.',
